...
\begin{frame}
    ...
    \begin{columns}[t] % The "c" option specifies centered vertical alignment while the "t" option is used for top vertical alignment
		\begin{column}{0.45\textwidth} % Left column width
			 \begin{itemize}
      \item Fue desarrollado por John Von Neuman en 1945.
      \item Es un algoritmo recursivo bastante eficiente para ordenar un array, que tiene un orden de complejidad 0(n.log(n))
      ...
      \item Costo computacional: T(N) = N * log2 N  
    \end{itemize}
